  ...
  return (
    ...
    >
      {currentLocation ? (
        ...
        >
          <div className="hud-panel hud-corners px-md py-md text-center font-hud-mono uppercase tracking-widest text-sm max-w-md">
            {locLoading
              ? "Locating you…"
              : locError
      ...
      {(loading || error) && (
        <div
          ...
          className="absolute top-2 left-2 z-50 hud-panel px-md py-xs text-xs font-hud-mono uppercase tracking-widest text-on-surface-variant"
        >
