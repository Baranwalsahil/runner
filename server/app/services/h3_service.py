...
# This is the weak-signal gap-fill cap: a gap up to 1 km is plausibly caused
# by a momentary GPS outage and should be bridged so the runner's territory
# has no holes.  Gaps wider than this are treated as GPS teleports/spoofs and
# are NOT bridged (both endpoint cells are still claimed).
GAP_BRIDGE_MAX_M = 1000.0
